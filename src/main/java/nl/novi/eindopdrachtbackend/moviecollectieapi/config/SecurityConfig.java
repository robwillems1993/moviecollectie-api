    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.GET, "/movies","/movies/*").hasAnyRole("USER","ADMIN")
                        .requestMatchers(HttpMethod.POST, "/movies").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/movies/*").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/movies/*").hasRole("ADMIN")

                        .requestMatchers(HttpMethod.GET, "/genres", "/genres/*").hasAnyRole("USER","ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET,"/collections", "/collections/*").hasAnyRole("USER","ADMIN")
